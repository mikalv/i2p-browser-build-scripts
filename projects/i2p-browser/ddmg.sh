...
genisoimage -D -V "I2P Browser" -no-pad -R -apple -o "\$dmg_tmpdir/i2bb-uncompressed.dmg" -path-list [% filelist %] -graft-points -gid 20 -dir-mode 0755 -new-dir-mode 0755

dmg dmg "\$dmg_tmpdir/i2bb-uncompressed.dmg" [% c('dmg_out', { error_if_undef => 1 }) %]
popd
